...
export class DeviceManagementComponent implements OnInit {
  ...
  loadMockData() {
    ...
    this.devices = [
      ...
      {
        id: 4,
        deviceName: 'Lisa Wang MacBook',
        deviceId: 'macbook-lw-004',
        deviceType: 'Laptop',
        platform: 'macOS',
        ...
        securityAlerts: 0,
        tags: ['it', 'laptop', 'macbook'],
        recentAlerts: [],
        description: 'IT department MacBook for development',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString()
      },
      {
        id: 5,
        deviceName: 'Tom Brown Windows Laptop',
        deviceId: 'laptop-tb-005',
        deviceType: 'Laptop',
        platform: 'Windows',
        ...
        securityAlerts: 1,
        tags: ['finance', 'laptop', 'windows'],
        recentAlerts: [
          {
            id: 1,
            message: 'Encryption not enabled - compliance risk',
            severity: 'warning',
            timestamp: new Date(Date.now() - 120000).toISOString(),
            deviceId: 'laptop-tb-005'
          }
        ],
        description: 'Finance department Windows laptop',
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString()
      }
    ];
